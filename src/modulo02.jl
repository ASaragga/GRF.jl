...
function alocar(Sigma, mu, lista, ncarteiras = 10)
    ...
    fig = groupedbar(wk', bar_position = :stack, bar_width=1.0, xlabel = "Carteiras", xticks=(1:ncarteiras, ticklabel), ylabel = "Pesos", label = permutedims(String.(lista)), legend = :outertopright, legendfontsize = 5, framestyle = :box)
    return fig
end
